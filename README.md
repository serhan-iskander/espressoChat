...
Alternatively, you can use the minimal static client:
- Backend already serves `public/` statically.
- Open `http://localhost:4000` after `pnpm dev`.

## Quick Test Flow
1. Ensure `.env` has a valid `GOOGLE_CLIENT_ID`.
